...
# ================================
# PROJECT RAG: файлы проектов в MinIO + индексация в project_rag_*
# ================================

@app.post("/api/project-rag/projects/{project_id}/documents")
...
@app.get("/api/project-rag/projects/{project_id}/documents")
...
@app.delete("/api/project-rag/projects/{project_id}/documents/{document_id}")
...
@app.post("/api/project-rag/projects/{project_id}/search")
...
# ================================
# УПРАВЛЕНИЕ ПРОЕКТАМИ (оркестрация удаления)
# ================================
...
async def delete_project(project_id: str):
    ...
    # 2. Удаляем диалоги проекта из MongoDB
    try:
