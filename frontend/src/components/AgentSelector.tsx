...
export default function AgentSelector({ isDarkMode = true, maxWidth, triggerMaxWidth, onAgentChange, onModelSelect }: AgentSelectorProps) {
  ...
  const handleSelectAgent = (agent: Agent) => {
    ...
    localStorage.setItem(STORAGE_AGENT_NAME, agent.name);
    localStorage.setItem(STORAGE_AGENT_PROMPT, agent.system_prompt || '');
    setActiveAgent({ id: agent.id, name: agent.name, system_prompt: agent.system_prompt || '' });
                  ...
                  <>
                    ...
                    {filteredAgents.map((agent) => (
                      <Box
                        ...
                        sx={{ ...DROPDOWN_ITEM_SX, display: 'flex', alignItems: 'center', gap: 1, color: activeAgent?.id === agent.id ? 'white' : 'rgba(255,255,255,0.9)', fontWeight: activeAgent?.id === agent.id ? 600 : 400, bgcolor: activeAgent?.id === agent.id ? DROPDOWN_ITEM_HOVER_BG : 'transparent' }}
                      >
                        <AgentIcon sx={{ fontSize: 18, color: 'rgba(255,255,255,0.7)', flexShrink: 0 }} />
                      ...
                      return (
                        <Box
                          ...
                          sx={{
                            ...
                            bgcolor: isSelected ? DROPDOWN_ITEM_HOVER_BG : 'transparent',
                          }}
                        >
                          <ComputerIcon sx={{ fontSize: 18, color: 'rgba(255,255,255,0.7)', flexShrink: 0 }} />
